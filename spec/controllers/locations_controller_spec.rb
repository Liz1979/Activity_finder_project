...
RSpec.describe LocationsController, type: :controller do
  ...
  let(:valid_attributes) {{name: "bar", country: "ES", longitude: -23.8974, latitude: 45.7352}}

  let(:invalid_attributes) {{name: nil, country: "ES", longitude: -23.8974, latitude: 45.7352}}

  let!(:changeme_activity) {Location.create(name: "changeme", country: "ES", longitude: -23.8974, latitude: 45.7352) }

  let!(:deleteme_activity) {Location.create(name: "changeme", country: "ES", longitude: -23.8974, latitude: 45.7352) }
